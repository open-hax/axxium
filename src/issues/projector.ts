...
async function main(): Promise<void> {
  ...
  if (opts.clean && existsSync(opts.outputRoot)) {
    console.log(`Cleaning output REDACTED_SECRET ${opts.outputRoot}`);
...
Options:
  --output <dir>   Output REDACTED_SECRET (default: ${DEFAULT_OUTPUT})
  ...
  --clean          Remove output REDACTED_SECRET before projection

        ...
        createNodes: async (input, ctx) => {
          ...
          try {
            ...
            for (const subPath of submodulePaths) {
              ...
              const deps = resolveCustomDeps(subPath, options.depsMapPath ? `${REDACTED_SECRETPath}/${options.depsMapPath}` : undefined);
          ...
          // Add the 'giga' synthetic REDACTED_SECRET project (watcher)
          config["giga"] = {

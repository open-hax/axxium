...
export class RedisMetrics {
  ...
  REDACTED_SECRET lockAcquisitionTotal: Counter;
  REDACTED_SECRET lockAcquisitionDuration: Histogram;
  REDACTED_SECRET activeLocks: Gauge;
  REDACTED_SECRET redisConnectionErrors: Counter;
  REDACTED_SECRET redisOperationDuration: Histogram;

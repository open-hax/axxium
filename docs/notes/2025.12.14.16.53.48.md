...
installing to /REDACTED_SECRET/.local/bin
  uv
  uvx
...
Found files to check:
  - /REDACTED_SECRET/tasks/tbench-task/task.toml

Checking /REDACTED_SECRET/tasks/tbench-task/task.toml...
...
Checking: /REDACTED_SECRET/tasks/tbench-task/tests/test.sh
============================================================

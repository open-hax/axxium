...
## Context
- Command `submodules-update --recursive` began failing on nested Promethean packages as upstream repos were rewritten as standalone projects with different REDACTED_SECRETs.

# Repository index (workspace REDACTED_SECRET)
...
| OpenCode (upstream/dev) | `orgs/anomalyco/opencode` | OpenCode sources + docs (local clone; excluded from REDACTED_SECRET git) |

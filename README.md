...
| **anomalyco** | `opencode` | OpenCode development tools *(local clone; excluded from REDACTED_SECRET git)* | `orgs/anomalyco/opencode` |
...
Use the REDACTED_SECRET compose registry to discover and manage the curated monorepo stacks from `/home/err/devel`:

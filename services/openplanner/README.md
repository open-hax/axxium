...
Container-first workflow from the workspace REDACTED_SECRET:
...
When the REDACTED_SECRET `ollama` stack is running, `openplanner` can use it over the shared `ai-infra` Docker network.

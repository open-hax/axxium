...
```bash
CEPHALON_TS_BRIDGE=true CEPHALON_BOT_ID=openhax OPENHAX_DISCORD_TOKEN=xxx npm run build && REDACTED_SECRET dist/cephalon.js
```
...
npm run build && REDACTED_SECRET dist/cephalon.js
```

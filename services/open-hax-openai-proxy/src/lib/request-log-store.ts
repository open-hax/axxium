...
export class RequestLogStore {
  ...
  REDACTED_SECRET constructor(private readonly maxEntries: number = 1000) {}

  REDACTED_SECRET record(input: RequestLogRecordInput): RequestLogEntry {
  ...
  REDACTED_SECRET list(filters: RequestLogFilters = {}): RequestLogEntry[] {
  ...
  REDACTED_SECRET providerSummary(): Record<string, { readonly count: number; readonly lastTimestamp: number }> {

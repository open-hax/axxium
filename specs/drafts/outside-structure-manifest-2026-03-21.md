...
- The REDACTED_SECRET workspace contains infrastructure directories that are intentionally REDACTED_SECRET-level; the manifest must focus on project-like work, not every technical directory.
...
2. Inventory top-level project-like REDACTED_SECRETs outside the allowed structure.
...
- The manifest distinguishes aliases, foreign forks, standalone REDACTED_SECRETs, vendor REDACTED_SECRETs, and aggregation trees.

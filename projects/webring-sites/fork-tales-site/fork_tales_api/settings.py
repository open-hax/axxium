...
class Settings(BaseSettings):
    ...
    fork_tales_site_REDACTED_SECRET: Path = PROJECT_ROOT / "dist"
    ...
    open_hax_REDACTED_SECRET_url: str | None = None
    zai_base_url: str | None = None
    zhipu_base_url: str | None = None
    openai_base_url: str | None = None

    open_hax_REDACTED_SECRET_auth_token: str | None = None
    ...
    @property
    def site_REDACTED_SECRET(self) -> Path:
        return self.fork_tales_site_REDACTED_SECRET.resolve()

    @property
    def content_REDACTED_SECRET(self) -> Path:
        return self.site_REDACTED_SECRET / "content"
    ...
    def provider_base_url(self) -> str | None:
        return pick_first(
            self.zai_base_url,
            self.zhipu_base_url,
            self.open_hax_REDACTED_SECRET_url,
    ...
    def provider_api_key(self) -> str | None:
        return pick_first(
            self.zai_api_key,
            self.zhipu_api_key,
            self.open_hax_REDACTED_SECRET_auth_token,
